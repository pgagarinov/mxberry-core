...
% 08.09.11    R2011b compatibility change. Use catch e (R2008a
%             compatibility only now required)
...
switch index(1).type
    case '.'
        switch lower(index(1).subs)
                    ...
                    try
                        ...
                        switch exc.identifier
                            case 'MATLAB:unassignedOutputs'
                                % NB subsref call above will have done the 
                                % work rgardless of subsequent exception
                                return
                            otherwise
            ...
            case 'uipanel'
                % Added 20.08.2011
                error('jcontrols no longer have a uipanel');
            case 'user'
                % Added 01.03.10
                ret=obj.User;
            case 'super'
