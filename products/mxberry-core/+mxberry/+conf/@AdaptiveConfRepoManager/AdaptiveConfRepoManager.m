classdef AdaptiveConfRepoManager<mxberry.conf.ConfRepoManager
    ...
    methods
        ...
        function setConfPatchRepo(self,confPatchRepo)
            % SET
            setConfPatchRepo@mxberry.conf.ConfRepoManager(self,confPatchRepo);
        ...
        function self=AdaptiveConfRepoManager(varargin)
            ...
            import mxberry.conf.AdaptiveConfRepoManager;
            import mxberry.core.throwerror;
            %
            %% parse input params
            [~,hostName]=mxberry.system.getuserhost();
            %
            [restArgList,~,templateStorageBranchKey,confPatchRepo,...
                ...
                'isstring(x)'});
            %%
            self=self@mxberry.conf.ConfRepoManager(...
            ...
            self.templateRepoMgr=mxberry.conf.ConfRepoManager(...
        ...
        function updateAll(self,areAllBranchesUpdated)
            ...
            if nargin<2
                ...
                mxberry.core.checkvar(areAllBranchesUpdated,...
