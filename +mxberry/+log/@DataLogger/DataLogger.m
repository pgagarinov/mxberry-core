classdef DataLogger<mxberry.core.obj.StaticPropStorage
    ...
    methods (Static)
        function configure(varargin)
            ...
            if ~mxberry.io.isdir(storageLocation)
                mxberry.io.mkdir(storageLocation);
            end
            ...
            feval(setMethodName,'filePostfix',mxberry.system.getpidhost());
        end
        %
    ...
    methods (Access=protected,Static)
        ...
        function fileName=getDataFileName(shortFuncName,fullFuncName)
            ...
            fileName=[feval(getMethodName,'storageLocation') filesep ...
                ...
                datestr(now,30) '_' mxberry.core.hash(fullFuncName) '.mat'];
        end
        %
        function [shortFuncName,fullFuncName,isLogged]=getFunctionProps(indStack)
            ...
            if ~isFound
                mxberry.core.throwerror('wrongCall',[...
            ...
            if nargout>1
                ...
                fullFuncName=cell2tablestr([],[prefixList {fullFuncName}],'.');
                if nargout>2
