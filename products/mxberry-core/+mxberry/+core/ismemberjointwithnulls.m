...
for iElem=1:nElems
    ...
    [leftIsNullMat,~,indLeftNullVec]=mxberry.core.uniquerows(...
        leftIsNullCVec{iElem},true);
    [rightIsNullMat,~,indRightNullVec]=mxberry.core.uniquerows(...
        rightIsNullCVec{iElem},true);
    [isLeft2RightNullVec,indLeft2RightNullVec]=...
        mxberry.core.ismemberrows(leftIsNullMat,rightIsNullMat,true);
...
%
if nargout>1
    [isMemberVec(:),indMemberVec(:)]=mxberry.core.ismemberrows(...
        leftIndMat,rightIndMat,true);
else
    isMemberVec(:)=mxberry.core.ismemberrows(leftIndMat,rightIndMat,true);
end
