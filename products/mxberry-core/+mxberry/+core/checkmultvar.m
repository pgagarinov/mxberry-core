...
if isempty(varargin)
    ...
    [reg,~,nCallerStackStepsUp]=mxberry.core.parseparext(varargin,...
...
if ~isOk
    ...
    defaultErrorMessage=...
        ...
        'conditions: %s'];
    %
    [~,~,varNameList,errorTag,errorMessage]=mxberry.core.parseparext(...
        reg((nPlaceHolders+1):end),...
        {...
        'varNameList','errorTag','errorMessage';...
        {},'wrongInput',defaultErrorMessage;...
        @iscellofstring,@isstring,@isstring...
        },0);
    %
    ...
    errorMessage=sprintf(errorMessage,...
        mxberry.core.cell.cell2tablestr([],varNameList,','),checkName);
    %
