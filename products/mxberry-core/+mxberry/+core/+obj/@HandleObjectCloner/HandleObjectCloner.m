classdef HandleObjectCloner<handle
    ...
    properties (Access=private)
        comparisonMode=mxberry.core.obj.ObjectComparisonMode.UserDefined;
    end
    %
    methods (Access=protected)
        function blobComparisonHook(self) %#ok<MANU>
        end
    end
    ...
    methods (Access=protected)
        function propCheckCMat=getHandleClonerIsEqualPropCheckCMat(self,...
                propNameList)
            import mxberry.core.obj.ObjectComparisonMode;
    ...
    methods (Access=protected,Sealed)
        function [regArgList,propEqScalarList]=...
                ...
                propListToParse)
            import mxberry.core.parseparams;
            ...
            [regArgList,~,eqRelatedPropValList]=...
                mxberry.core.parseparext(propListToParse,...
                eqPropCheckCMat,...
    ...
    methods (Sealed)
        ...
        function [resObjVec,indVec]=sort(inpObjVec)
            ...
            prevMode=inpObjVec.setComparisonMode(ObjectComparisonMode.Blob);
            try
                [resObjVec,indVec]=mxberry.core.sort.mergesort(inpObjVec);
                inpObjVec.setComparisonMode(prevMode);
            catch meObj
                inpObjVec.setComparisonMode(prevMode);
                rethrow(meObj);
        ...
        function [isEq,reportStr]=isEqual(varargin)
            ...
            if isReportRequired
                ...
                if length(reportStrList)>1
                    reportStr=mxberry.core.string.catwithsep(reportStrList,...
                        sprintf('\n'));
                ...
                if isClassCompared&&(~isa(otherArr,class(selfArr)))
                    ...
                    if ~isempty(isEqArr)
                        ...
                        if nargout>1
                            ...
                            if length(reportStrList)>1
                                reportStr=mxberry.core.string.catwithsep(...
