classdef StructDisp < handle
    ...
    methods
        function self=StructDisp(varargin)
            ...
            %          Ilya Roublev, PhD  <iroublev@gmail.com> $
        ...
        function resStr=char(self)
            % toString returns string with displayed outline of structure or
            ...
            %
            %
            resultString=mxberry.core.string.catwithsep(self.dispCVec,...
                sprintf('\n'));
    ...
    methods (Static)
        function resStr=strucdisp(varargin)
            ...
            listStr = mxberry.core.struct.StructDisp.recFieldPrint(SInp, 0,...
                propValCVec{:});
            ...
            resultString=mxberry.core.string.catwithsep(listStr,sprintf('\n'));
            if nargout==0
