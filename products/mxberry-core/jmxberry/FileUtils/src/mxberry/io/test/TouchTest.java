...
public class TouchTest {
	...
	public void test() {
		...
		String[] files=mxberry.io.FileUtils.listDirsRecursive(pathStr,"glob:**",0);
		java.lang.System.out.println(Arrays.toString(files));
		//files=matrixberry.io.FileUtils.listFilesRecursive(path,"regex:.*m$",0);
